...
- Android Studio or Gradle CLI / Android Studio 或命令行 Gradle
...
- DeepSeek v4 flash — default AI model for chat and daily reports / 默认的 AI 对话与日报模型
